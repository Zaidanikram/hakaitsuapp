...
import { RiFacebookCircleFill, RiTwitterXLine, RiLinkedinFill, RiGithubLine, RiCircleFill, RiDownloadLine, RiInstagramFill } from '@remixicon/react'
                    ...
                    <div className="col-lg-4">
                        <SlideUp>
                            <div className="about-image-part">
                                ...
                                <h2>Hakai Tsu</h2>
                                <p>I am Full stack developer based in Jakarta.</p>
                                <div className="about-social text-center">
                                    <ul>
                                        <li><Link href=""><RiFacebookCircleFill size={20} /></Link></li>
                                        <li><Link href=""><RiInstagramFill size={20} /></Link></li>
                    ...
                    <div className="col-lg-8">
                        <SlideUp>
                            <div className="about-content-part">
                                <p>Hello There!</p>
                                <h2>
                                    I’m Hakai Tsukihara, a Full stack developer based on Jakarta .
                                </h2>
